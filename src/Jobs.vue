            ...
            <div class="d-flex justify-content-center align-items-center">
                <draggable v-model="jobs" item-key="id">
                    <template #item="{ element }">
                        <div class="border border-3 rounded m-1 p-2">
                            <p>
                            ...
                            <p class="p-0 m-0">
                                 <strong>Статус:</strong> {{ element.status }}                                
                            </p>
                            <p class="p-0 m-0">
            ...
            <div class="d-flex">
                <div class="col align-self-center offset-md-5">
                    <div class="d-flex mt-3 ">
                        <router-link class="btn btn-success shadow" to="/create-jobs">Добавить новую
                            задачу</router-link>
                    </div>
                    <div class="d-flex mt-3 ms-5 ps-4">
